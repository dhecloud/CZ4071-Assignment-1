...
class MainApp:
    def __init__(self, master, p):
        ...
        self.button1 = tk.Button(self.frame, text = 'View Network Properties', width = 50, command = self.new_window_model)
        self.button1.pack()
        self.button2 = tk.Button(self.frame, text = 'View Random Network (RN) properties', width = 50, command = self.new_window_RN)
        self.button2.pack()
        self.compareButton1 = tk.Button(self.frame, text = "Compare RN properties with yours", width = 50, command = self.compare_RN_with_model)
        ...
        self.button3.pack()
        self.compareButton2 = tk.Button(self.frame, text = "Compare SF properties with yours", width = 50, command = self.compare_SF_with_model)
        ...
        self.button4.pack()
        self.compareButton3 = tk.Button(self.frame, text = "Compare BA properties with yours", width = 50, command = self.compare_BA_with_model)
        self.compareButton3.pack()     
        self.visualizeButton = tk.Button(self.frame, text = "Visualize the network's largest hub", width = 50, command = self.visualize_model)
...
class ModelProperties:
    def __init__(self, master, p):
        ...
        self.dmax, self.kin[0], self.kin[1], self.kin[2], self.kin[3], self.degdist[0],self.degdist[1],self.degdist[2],self.degdist[3], self.numnodes, self.acc, self.apl, self.avgdeg = p
        self.frame = tk.Frame(self.master)
        self.degdis_Text = tk.Text(self.frame, height=4,width=100)
        self.degdis_Text.insert(tk.INSERT,'Network degree distribution for k = ' + str(self.kin[0]) + ' is approximately' + str(self.degdist[0]) +  '\n')
        self.degdis_Text.insert(tk.INSERT,'Network degree distribution for k = ' + str(self.kin[1]) + ' is approximately' + str(self.degdist[1]) +  ' \n')
        self.degdis_Text.insert(tk.INSERT,'Network degree distribution for k = ' + str(self.kin[2]) + ' is approximately' + str(self.degdist[2]) +  '\n')
        self.degdis_Text.insert(tk.INSERT,'Network degree distribution for k = ' + str(self.kin[3]) + ' is approximately'+ str(self.degdist[3]))
        self.degdis_Text.pack()
        self.apl_Text = tk.Text(self.frame, height=2,width=100)
        self.apl_Text.insert(tk.INSERT,'Network average path length for N = ' +  str(self.numnodes) + 'is '+ str(self.apl))
        self.apl_Text.pack()
        self.acc_Text = tk.Text(self.frame, height=2,width=100)
        self.acc_Text.insert(tk.INSERT,'Network average clustering coefficient for N = ' +  str(self.numnodes)  + ' is ' + str(self.acc))
        self.acc_Text.pack()  
        self.avgdeg_Text = tk.Text(self.frame, height=2,width=100)
        self.avgdeg_Text.insert(tk.INSERT,'Network average degree for N = ' +  str(self.numnodes)  + ' is ' + str(self.avgdeg))
        self.avgdeg_Text.pack()  
        self.quitButton = tk.Button(self.frame, text = 'Quit', width = 25, command = self.close_windows)
        self.quitButton.pack()
        self.frame.pack()
...
class RNProperties:
    def __init__(self, master, p):
        self.master = master
        self.degdist = [0,0,0,0]
        self.numnodes, self.degdist[0],self.degdist[1],self.degdist[2],self.degdist[3], self.apl, self.acc, self.avgdeg= p
        self.frame = tk.Frame(self.master)
        self.degdis_Text = tk.Text(self.frame, height=4,width=100)
        ...
        self.acc_Text.pack()  
        self.avgdeg_Text = tk.Text(self.frame, height=2,width=100)
        self.avgdeg_Text.insert(tk.INSERT,'RN average degree for N = ' +  str(self.numnodes)  + ' is expected to be ' + str(self.avgdeg))
        self.avgdeg_Text.pack()  
        self.quitButton = tk.Button(self.frame, text = 'Quit', width = 25, command = self.close_windows)
        self.quitButton.pack()
        self.frame.pack()
...
class SFProperties:
    def __init__(self, master, p):
        self.master = master
        self.degdist = [0,0,0,0]
        self.numnodes, self.degdist[0],self.degdist[1],self.degdist[2],self.degdist[3], self.apl, self.hub, self.avgdeg = p
        self.frame = tk.Frame(self.master)
        self.degdis_Text = tk.Text(self.frame, height=4,width=100)
        ...
        self.hub_Text.pack()  
        self.avgdeg_Text = tk.Text(self.frame, height=2,width=100)
        self.avgdeg_Text.insert(tk.INSERT,'SF average degree for N = ' +  str(self.numnodes)  + ' is expected to be ' + str(self.avgdeg))
        self.avgdeg_Text.pack()  
        self.quitButton = tk.Button(self.frame, text = 'Quit', width = 25, command = self.close_windows)
        self.quitButton.pack()
        self.frame.pack()
...
class CompareBA:
    def __init__(self, master, model, BA):
        ...
        self.dmax, self.kinmodel[0], self.kinmodel[1], self.kinmodel[2], self.kinmodel[3], self.degdistmodel[0],self.degdistmodel[1],self.degdistmodel[2],self.degdistmodel[3], self.numnodesmodel, self.accmodel, self.aplmodel,  self.avgdeg = model
        ...
        self.l1 = tk.Label(self.frame,text=" Network ", relief=tk.SOLID,width = 35)
...
class CompareRN:
    def __init__(self, master, model, RN):
        ...
        self.numnodesRN, self.degdistRN[0],self.degdistRN[1],self.degdistRN[2],self.degdistRN[3], self.aplRN, self.accRN, self.avgdegRN = RN
        self.master = master
        self.frame = tk.Frame(self.master)
        self.hub_Text = tk.Text(self.frame, height=4,width=30)
        self.hub_Text.insert(tk.INSERT,'numnodes = Number of Nodes\n')
        ...
        self.hub_Text.insert(tk.INSERT,'acc= Average Clustering Coeff\n')
        self.hub_Text.grid() 
        self.hub_Text.insert(tk.INSERT,'avgdeg= Average degree\n')
        self.hub_Text.grid()
        ...
        self.acc = tk.Label(self.frame,text="      acc      ", relief=tk.SOLID,width = 35)
        self.acc.grid(row=4,column=2)
        self.acc = tk.Label(self.frame,text="      avgdeg       ", relief=tk.SOLID,width = 35)
        self.acc.grid(row=5,column=2)
        ...
        self.acc = tk.Label(self.frame,text=self.accmodel, relief=tk.RIDGE,width = 35)
        self.acc.grid(row=4,column=3)
        self.deg = tk.Label(self.frame,text=self.avgdeg, relief=tk.RIDGE,width = 35)
        self.deg.grid(row=5,column=3)
        ...
        self.acc.grid(row=4,column=5)
        self.deg = tk.Label(self.frame,text=self.avgdegRN, relief=tk.RIDGE,width = 35)
        self.deg.grid(row=5,column=5)
...
class CompareSF:
    def __init__(self, master, model, SF):
        ...
        self.numnodesSF, self.degdistSF[0],self.degdistSF[1],self.degdistSF[2],self.degdistSF[3], self.aplSF, self.hubSF, self.avgdegSF = SF
        self.master = master
        self.frame = tk.Frame(self.master)
        self.hub_Text = tk.Text(self.frame, height=4,width=30)
        self.hub_Text.insert(tk.INSERT,'numnodes = Number of Nodes\n')
        ...
        self.acc.grid(row=4,column=5)
        self.degSF = tk.Label(self.frame,text=self.avgdegSF, relief=tk.RIDGE,width = 35)
        self.degSF.grid(row=5,column=5)
...
def getfilepath():
    print("\nChoose csv file to be analysed\n   ")
    filename = filedialog.askopenfilename(initialdir = os.getcwd(), title = "Select file", filetypes = (("Comma Separated Values", "*.csv"),))
    return filename
    
def main(): 
    root = tk.Tk()
    root.withdraw()
    root.filename = getfilepath()
    root.update()
    print("\n\n\nLoading... Hang on for a minute or so..\n\n\n")
    os.system("python properties.py " + str(root.filename))
    print("Loading done!\n\n")
    p = read_properties()
    root.deiconify()
    app = MainApp(root, p)
    app.master.title("CZ4071 Network GUI")
    root.mainloop()
